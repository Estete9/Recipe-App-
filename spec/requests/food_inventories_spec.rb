  ...
  describe 'POST /food_inventories' do
    context 'with valid parameters' do
      it 'creates a new food_inventory' do
        expect do
          post food_inventories_path, params: { food_inventory: attributes_for(:food_inventory, inventory_id: inventory.id, food_id: food.id) }
    ...
    context 'with invalid parameters' do
      it 'does not create a new food_inventory' do
        expect do
          post food_inventories_path, params: { food_inventory: { quantity: nil, inventory_id: inventory.id, food_id: food.id } }
